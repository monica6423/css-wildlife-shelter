...
// init controller
var page1 = new ScrollMagic.Controller({globalSceneOptions: {duration: 1000}});
var page2 = new ScrollMagic.Controller({globalSceneOptions: {duration: 800}});
var page3 = new ScrollMagic.Controller({globalSceneOptions: {duration: 1400}});
var page4 = new ScrollMagic.Controller({globalSceneOptions: {duration: 1300}});
...
/****PARALLAX SCROLLING */
var paralax = new ScrollMagic.Controller({globalSceneOptions: {triggerHook: "onEnter", duration: "200%"}});
new ScrollMagic.Scene({triggerElement: "#parallax3"})
    .setTween("#parallax3 > div", {y: "65%", ease: Linear.easeNone})
    .addIndicators({
                  colorTrigger: "transparent",
                  colorStart: "transparent",
                  colorEnd: "transparent",
...
$(".para").each(function() {
  ...
  para.to(child, 1, { y: -100, ease: Linear.easeNone });
...
const t1 = new TimelineMax();
  t1.fromTo(zero,1.5,{width: "80%"},{width:"20%",ease:Power0.easeNone})
  t1.fromTo(zero,1,{height: "100%"},{height:"0%",ease:Power2.easeInOut})
  t1.fromTo(slider,1,{height: "100%"},{height:"0%",ease:Power2.easeInOut}, "-=1")
  t1.fromTo(slider,1,{width: "100%"},{width:"0%",ease:Power2.easeInOut})
  t1.fromTo(text,.2,{opacity: 1, x: 0, y:150 },{opacity: 0, x:-40, y:150 }, "-=1")
  t1.fromTo(headline,.7,{opacity: 0, x: 100},{opacity: 1, x:0 }, "-=0.5")
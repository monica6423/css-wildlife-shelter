document.addEventListener('DOMContentLoaded', () => {
    ...
    nav.addEventListener('click', () => {
        ...
        timeline2
            ...
            .to('.birdpic', 3, {y: -600,scale: 1.1,ease: Expo.easeInOut})
            .to('.box', 3, {y: -800,ease: Expo.easeInOut}, '-=3')
            .to('.anime1', 3, {autoAlpha: 0,y: -100,ease: Expo.easeInOut}, '-=3')
...
var tl = gsap.timeline({defaults:{duration: 1}});
            tl.from(".anime1", {y:60, stagger: .8, opacity: 0})
              .to(rule, {duration: 1.5,cssRule: {scaleY: 0}}, "-=2")
              .from(".box", {backgroundPosition: '600px 0px', opacity: 0}, "-=.9")
              .from(".birdpic", {y:30, opacity: 0})
